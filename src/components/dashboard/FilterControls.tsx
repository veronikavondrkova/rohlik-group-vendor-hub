...
const FilterControls = ({
  ...
  return <div className="flex items-center gap-4 mb-4">
      ...
      <div className="flex items-center">
        <span className="mr-2 text-sm font-medium">Asset format:</span>
      ...
      {(statusFilter !== 'all' || formatFilter !== 'all') && <Button variant="outline" size="sm" onClick={onClearFilters} className="ml-2">
          Clear filters
        </Button>}
    </div>;
};
