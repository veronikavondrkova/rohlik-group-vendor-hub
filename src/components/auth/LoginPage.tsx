  ...
  return <div className="flex min-h-screen bg-black">
      <div className="m-auto w-full max-w-md my-[49px]">
        ...
        <div className="flex justify-center mb-6 my-[49px]">
          <img src="/logogrouplogin.png" alt="Group logo" className="w-20 h-auto my-[18px]" />
        </div>
        
        <div className="mb-8 text-center">
          <h1 className="text-white mb-4 text-6xl font-extrabold">Welcome!</h1>
        ...
        <div className="mt-6 flex justify-center px-0">
          <img alt="Partner logos" src="/lovable-uploads/27ac72ce-dc02-4781-b1b6-02d810af0475.png" className="w-[300px] h-auto py-0 my-[18px]" />
        </div>
