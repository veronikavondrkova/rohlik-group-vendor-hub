          ...
          {user && (
            <div className="flex items-center">
              ...
              <Button 
                ...
                className="border-white/50 ml-2 text-black bg-gradient-to-b from-white to-gray-100 hover:from-gray-100 hover:to-white shadow-md hover:shadow-lg transition-all duration-300"
              >
                Logout
              </Button>
            </div>
